...
if(!isset($_POST['confirm_edit']) || !isset($_SESSION["catalog_id"])){
...
$sql = "UPDATE `catalogs` SET `catalog_name` = '$catalog_name', `auction_type` = '$auction_type', `charity` = '$charity', `catalog_description` = '$catalog_description', `start_date` = '$start_date', `start_time` = '$start_time', `end_date` = '$end_date', `end_time` = '$end_time', `end_increment` = '$end_increment', `house_list` = '$house_list', `currency` = '$currency', `timezone` = '$timezone', `buyer_premium` = '$buyer_premium', `asset_location_1` = '$asset_locations[0]', `asset_location_2` = '$asset_locations[1]', `asset_location_3` = '$asset_locations[2]', `asset_location_4` = '$asset_locations[3]', `asset_location_5` = '$asset_locations[4]', `inspection_1` = '$asset_inspections[0]', `inspection_2` = '$asset_inspections[1]', `inspection_3` = '$asset_inspections[2]', `inspection_4` = '$asset_inspections[3]', `inspection_5` = '$asset_inspections[4]', `inspection_6` = '$asset_inspections[5]', `inspection_7` = '$asset_inspections[6]', `inspection_8` = '$asset_inspections[7]', `inspection_9` = '$asset_inspections[8]', `inspection_10` = '$asset_inspections[9]', `removal_1` = '$asset_removals[0]', `removal_2` = '$asset_removals[1]', `removal_3` = '$asset_removals[2]', `removal_4` = '$asset_removals[3]', `removal_5` = '$asset_removals[4]', `removal_6` = '$asset_removals[5]', `removal_7` = '$asset_removals[6]', `removal_8` = '$asset_removals[7]', `removal_9` = '$asset_removals[8]', `removal_10` = '$asset_removals[9]', `contact_1` = '$asset_contacts[0]', `contact_2` = '$asset_contacts[1]', `contact_3` = '$asset_contacts[2]', `contact_4` = '$asset_contacts[3]', `contact_5` = '$asset_contacts[4]', `contact_6` = '$asset_contacts[5]', `contact_7` = '$asset_contacts[6]', `contact_8` = '$asset_contacts[7]', `contact_9` = '$asset_contacts[8]', `contact_10` = '$asset_contacts[9]', `question_1` = '$catalog_questions[0]', `question_2` = '$catalog_questions[1]', `question_3` = '$catalog_questions[2]', `question_4` = '$catalog_questions[3]', `question_5` = '$catalog_questions[4]', `question_6` = '$catalog_questions[5]', `question_7` = '$catalog_questions[6]', `question_8` = '$catalog_questions[7]', `question_9` = '$catalog_questions[8]', `question_10` = '$catalog_questions[9]', `terms_conditions` = '$terms_conditions' WHERE `catalogs`.`id` = '$catalog_id';";
