            ...
            <div class="catalog_item">
                ...
                <div class="details_and_actions">
                    ...
                    <div class="catalog_buttons">
                        <a href="<?php echo $root; ?>lots/create.php?cat_id=<?php echo $id; ?>" class="bidzbutton chocolate catalog_actions"><i class="fas fa-tasks special"></i> <span>Add/Manage Lots</span></a>
