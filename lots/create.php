...
<?php
    ...
    $times_the_bid = $row['times_the_bid'];
        ...
        <section class="catalog_create">
            ...
            <form action="<?php echo $root; ?>processes/process_lot_creation.php" method="post" name="lot_creation_form" id="lot_creation_form" >
                ...
                <div class="catalog_row signup_row">
                    ...
                    <a  type="submit" class="fancy-submit fancy-button bg-gradient1 cursor_pointer" style="margin:auto;"  id="create_lot_submit" disabled><span>Create Lot</span></a>
                </div>
            </form>
        </section>
    </form>
