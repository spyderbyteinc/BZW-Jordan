...
<?php
    ...
    $checks = array("name_check", "description_check", "category_check", "starting_bid_check", "bid_increment_type_check", "bid_increment_check", "lot_location_check", "reserve_check", "featured_check", "freezing_check", "times_the_bid_check", "quantity_check", "units_check", "brand_check", "condition_check", "size_check", "weight_check", "internal_notes_check", "tags_check");
...
<script>
    ...
    <?php if($category != -1) : ?>
        ...
        if(other_category != "" && other_category != "-1"){
        ...
        // populate select category fields
...
<script>
    ...
    var times_the_bid = "<?php echo $values['times_the_bid']; ?>";
