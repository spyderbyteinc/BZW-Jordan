...
-->
            ...
            <div class="bidding_buttons">
                <div class="bid_labels">
                    <span class="bid_proxy_label">Proxy Bid</span>
                    <span class="bid_max_label">Max Bid</span>
                </div>

                <div class="bid_inputs">
                    <input type="text" class="input_text lot_input" id="proxybid" name="proxybid" placeholder="Enter a bid of at least $5.00">
                    <input type="text" class="input_text lot_input" id="maxbid" name="maxbid" placeholder="Enter a max bid">
                </div>
            ...
            <div class="lot_participation_buttons">
                <div class="register_button">
                    <a class="bidzbutton" href="#"><i class="far fa-registered"></i> Register To Bid</a>
                </div>
