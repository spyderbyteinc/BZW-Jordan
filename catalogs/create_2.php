        ...
        <div class="modal_content inspection_modal">
            ...
            <div class="col2">
                    <div class="signup_group">
                        ...
                        <input type="text" class="input_text date date_picker" onkeypress="return false"  name="inspection_start_date" id="inspection_start_date" placeholder="mm/dd/yyyy" autocomplete="off">
                    </div>
                </div>
                <div class="col2">
                    <div class="signup_group">
...
<script src="js/catalog_helpers_2.js"></script>
